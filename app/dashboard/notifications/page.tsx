...
const typeColors: Record<string, string> = {
    ...
    request_response: "bg-purple-100 text-purple-600",
    ...
    quote: "bg-cyan-100 text-cyan-600",
                ...
                <div className="flex items-center gap-2 overflow-x-auto">
                    ...
                    {[
                        ...
                        <button
                            ...
                            className={`px-3 py-1.5 rounded-lg text-sm font-medium whitespace-nowrap transition-colors ${filter === opt.value
