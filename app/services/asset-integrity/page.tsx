...
export default function AssetIntegrityPage() {
    const capabilities = [
        {
            ...
            description:
                "Advanced inspection techniques including ultrasonic, radiographic, magnetic particle, and dye penetrant testing to detect defects without damaging your assets.",
            features: [
        ...
        },
        {
            ...
            description:
                "Comprehensive corrosion monitoring, assessment, and mitigation strategies to extend asset life and prevent unexpected failures.",
            features: [
        ...
        },
        {
            ...
            description:
                "Expert structural assessments and fitness-for-service evaluations to ensure continued safe operation of your critical infrastructure.",
            features: [
        ...
        },
        {
            ...
            description:
                "Ensure full compliance with international standards and regulatory requirements through thorough documentation and reporting.",
            features: [
                "API, ASME Compliance",
    ...
    const services = [
        ...
        "Subsea asset investigations",
        "Heat exchanger tube inspections",
        "Crane and lifting equipment surveys",
        "Riser and umbilical inspections",
        "Jacket and topside assessments",
        "Mooring system integrity checks",
    ];

    const stats = [
        { value: "500+", label: "Assets Inspected", icon: Target },
        { value: "99%", label: "Detection Accuracy", icon: Award },
    ...
    const process = [
        {
            ...
            description:
                "Comprehensive evaluation of your assets to identify critical inspection points and develop a risk-based inspection plan.",
            icon: AlertTriangle,
        },
        {
            step: "02",
            ...
            description:
                "Deployment of qualified inspectors using state-of-the-art NDT equipment and advanced inspection technologies.",
            icon: Eye,
        },
        {
            step: "03",
            title: "Data Analysis",
            description:
                "Expert analysis of inspection data with detailed reporting on findings, trends, and recommendations.",
            icon: Settings,
        },
        {
            step: "04",
            ...
            description:
                "Development of maintenance strategies and remediation plans to extend asset life and optimize performance.",
            icon: TrendingUp,
        },
    ];
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <section className="relative pt-40 pb-32 overflow-hidden bg-navy-900 before:absolute before:inset-0 before:bg-[url('/bg-pattern.svg')] before:opacity-5 before:z-0">
                <div className="absolute inset-0 bg-gradient-to-br from-navy-900 via-amber-950 to-primary-950 opacity-95 z-0"></div>

                {/* Animated Orbs */}
                <div className="absolute top-20 right-0 w-[500px] h-[500px] bg-amber-600/20 rounded-full blur-[128px] animate-pulse z-0 mix-blend-screen"></div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        ...
                        >
                            ...
                            <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight tracking-tight text-white">
                                Asset Integrity <br />
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-white to-amber-400">
                                    & Inspection
                                </span>
                            </h1>
                            <p className="text-xl text-gray-300 leading-relaxed mb-10 max-w-xl font-light">
                                Protecting your critical infrastructure with advanced inspection
                                technologies and expert integrity management solutions.
                            </p>
                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                <div className="flex items-center space-x-4 px-6 py-4 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
                                    <div className="flex -space-x-3">
                                        {[1, 2, 3].map((i) => (
                                            <div key={i} className="w-8 h-8 rounded-full bg-amber-500 border-2 border-navy-900 relative flex items-center justify-center text-[10px] font-bold text-white">
                                                <Eye className="w-4 h-4" />
                                            </div>
                                        ))}
                                    </div>
                                    <span className="text-sm text-gray-300 font-medium">Expert Inspectors</span>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        >
                            <div className="relative h-[600px] w-full rounded-[2.5rem] overflow-hidden shadow-2xl border border-white/10 group">
                                <Image
                                    src="/images/services/offshore-hero.png"
                                    alt="Asset Integrity Inspection"
                                    fill
                                ...
                                <div className="absolute bottom-8 left-8 right-8 bg-white/10 backdrop-blur-xl border border-white/20 p-6 rounded-2xl">
                                    <div className="flex items-center justify-between mb-4">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <div className="text-white font-bold">Inspection Status</div>
                                                <div className="text-green-400 text-xs font-bold uppercase tracking-wider">All Systems Verified</div>
                                            </div>
                                        </div>
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto font-light leading-relaxed">
                            Advanced technologies and expert analysis to protect your assets
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
                        {capabilities.map((capability, i) => (
                            ...
                            >
                                ...
                                <h3 className="text-2xl font-bold text-navy-900 mb-4 group-hover:text-amber-700 transition-colors">
                                    {capability.title}
                                </h3>
            ...
            <section className="py-24 bg-gray-50">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <span className="text-amber-600 font-semibold text-sm uppercase tracking-wide">Our Methodology</span>
                        <h2 className="text-4xl font-bold text-navy-900 mt-2">Inspection Workflow</h2>
                    </motion.div>
                        ...
                        {process.map((item, i) => (
                            ...
                            >
                                <div className="bg-white p-8 rounded-3xl shadow-lg border border-gray-100 h-full hover:shadow-xl transition-shadow duration-300">
                                    ...
                                    <div className="w-14 h-14 bg-amber-100 rounded-2xl flex items-center justify-center mb-6 text-amber-600 relative z-10">
            ...
            {/* CTA Section */}
            <section className="py-24 bg-gradient-to-br from-amber-900 via-orange-900 to-primary-950 text-white relative overflow-hidden">
                {/* Abstract Shapes */}
                <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-amber-600/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    <h2 className="text-4xl md:text-6xl font-bold mb-8">
                        Protect Your <br /> Critical Assets
                    </h2>
                    <p className="text-xl mb-12 max-w-2xl mx-auto text-gray-300 font-light">
                        Partner with us for comprehensive asset integrity management that extends
                        asset life and ensures operational safety.
                    </p>
